...
public class PlatformController : MonoBehaviour
{
    ...
    void SpeedOMeter()
    {
        ...
        int meters = (int)(timer * speed * 150); //Calcolo dei metri con il processo inverso di metri/secondo della velocità * 150 che è un numero fittizio per renderlo realistico
